...
void BindGroupSplitterLoader(py::module_& m) {
  py::class_<pioneerml::dataloaders::graph::GroupSplitterLoader>(m, "GroupSplitterLoader")
      .def(py::init<>())
      .def("load_config_json",
           [](pioneerml::dataloaders::graph::GroupSplitterLoader& loader,
