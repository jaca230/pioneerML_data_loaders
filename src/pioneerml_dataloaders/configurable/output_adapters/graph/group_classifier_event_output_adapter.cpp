...
GroupClassifierEventOutputAdapter::GroupOffsets GroupClassifierEventOutputAdapter::ComputeGroupOffsets(
...
std::shared_ptr<arrow::Array> GroupClassifierEventOutputAdapter::BuildGroupListColumn(
...
std::shared_ptr<arrow::Table> GroupClassifierEventOutputAdapter::BuildEventTable(
...
void GroupClassifierEventOutputAdapter::WriteParquet(
