...
// Derive per-time-group class energy sums: struct of three list<float> per row
// (pion_energy_per_group, muon_energy_per_group, mip_energy_per_group), aligned
// by time-group order.
class TimeGroupEnergyDeriver : public BaseDeriver {
 public:
  TimeGroupEnergyDeriver(std::string pdg_column = "hits_pdg_id",
