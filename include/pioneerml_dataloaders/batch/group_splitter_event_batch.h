...
struct GroupSplitterEventInputs : public BaseBatch {
  ...
  std::shared_ptr<arrow::Array> group_probs;      // float32, length = num_groups * 3
...
struct GroupSplitterEventTargets : public BaseBatch {
  std::shared_ptr<arrow::Array> y_node;    // float32, length = total_nodes * 3
  size_t num_graphs{0};
};
